...
// @updateURL    https://github.com/IvanAgafonov/test-violentmonkey/raw/main/megaeth_faucet.user.js
...
async function autoBuy() {
  ...
  var up = document.querySelector("input[placeholder='ENTER WALLET ADDRESS (0x...)']");
  if (up) {
  ...
  await sleep(getRandomDelay(1300, 2000));
  up = Array.from(document.querySelectorAll("button")).filter(el => el.textContent == "GET TESTNET ETH" );
  if (up.length != 0){
    triggerEvents(up[0]);
