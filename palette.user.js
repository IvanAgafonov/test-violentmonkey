...
// @version      0.1
// @author       IvanAgafonov
// @match        https://app.palette.finance/*
// @downloadURL  https://github.com/IvanAgafonov/test-violentmonkey/raw/main/palette.user.js
// @updateURL    https://github.com/IvanAgafonov/test-violentmonkey/raw/main/palette.user.js
...
async function autoBuy() {
  ...
  var up = Array.from(document.querySelectorAll("button")).filter(el => el.textContent == "Join the Waitlist" );
  if (up.length != 0){
    triggerEvents(up[0]);
    // up[0].click();
