...
// @version      0.1
// @author       IvanAgafonov
// @match        https://app.voidgame.io/*
// @downloadURL  https://github.com/IvanAgafonov/test-violentmonkey/raw/main/void.user.js
// @updateURL    https://github.com/IvanAgafonov/test-violentmonkey/raw/main/void.user.js
...
async function autoBuy() {
  ...
  var up = Array.from(document.querySelectorAll("button span")).filter(el => el.textContent == "Claim" );
  if (up.length != 0){
    triggerEvents(up[0]);
    // up[0].click();
