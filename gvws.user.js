...
// @version      0.11
// @author       IvanAgafonov
// @match        https://gvws.app/*
// @downloadURL  https://github.com/IvanAgafonov/test-violentmonkey/raw/main/gvws.user.js
// @updateURL    https://github.com/IvanAgafonov/test-violentmonkey/raw/main/gvws.user.js
...
async function autoBuy() {
  ...
  var up = Array.from(document.querySelectorAll("div span")).filter(el => el.textContent == "Summer DeFi");
  if (up.length != 0){
    triggerEvents(up[0]);
