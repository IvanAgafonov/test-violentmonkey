...
// @version      0.11
// @author       IvanAgafonov
// @match        https://drip.haus/
// @downloadURL  https://github.com/IvanAgafonov/test-violentmonkey/raw/main/drip_collect.user.js
// @updateURL    https://github.com/IvanAgafonov/test-violentmonkey/raw/main/drip_collect.user.js
...
async function autoBuy() {
  ...
  var up = Array.from(document.querySelectorAll("button")).filter(el => el.textContent == "Claim Free Collectible");
  if (up.length != 0){
    triggerEvents(up[0]);
...
function initializeScript() {
    ...
    setTimeout(autoBuy, getRandomDelay(17000, 19050));
}
