...
// @updateURL    https://github.com/IvanAgafonov/test-violentmonkey/raw/main/google_faucet.user.js
...
async function autoBuy() {
  ...
  var up = document.querySelector("input[placeholder='e.g., 0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045 or vitalik.eth']");
  if (up) {
    triggerEvents(up);
    up.value = evm_addr
...
function initializeScript() {
    ...
    setTimeout(autoBuy, getRandomDelay(10000, 12050));
}
