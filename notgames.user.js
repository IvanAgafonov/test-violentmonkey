...
// @version      0.1
// @author       IvanAgafonov
// @match        https://webapp.notcoin.tg/*
// @downloadURL  https://github.com/IvanAgafonov/test-violentmonkey/raw/main/notgames.user.js
// @updateURL    https://github.com/IvanAgafonov/test-violentmonkey/raw/main/notgames.user.js
...
async function autoBuy() {
  ...
  var up = Array.from(document.querySelectorAll("button")).filter(el => el.textContent == "Claim to my profile");
  if (up.length != 0){
    triggerEvents(up[0]);
