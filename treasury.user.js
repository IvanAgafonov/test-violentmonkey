...
async function autoBuy() {
  ...
  if (up.length != 0){
    ...
    if (up.length == 0){
      try{
        await fetch("http://127.0.0.1:5000/treasury?profile_number=" + profile_number);
      } catch (error) {}
    }
  }
...
//     up = Array.from(document.querySelectorAll("img[src='/images/icons/social/roof_icon_5.png']"));
//     if (up.length == 2){
//       mytext = "SCL";
//     }
...
//     up = Array.from(document.querySelectorAll("img[src='/images/icons/social/veranda_quest_icon_3.png']"));
//     if (up.length == 2){
//       mytext = "Rare";
//     }

//     up = Array.from(document.querySelectorAll("img[src='/images/icons/social/veranda_quest_icon_4.png']"));
//     if (up.length == 2){
//       mytext = "Book";
//     }
...
//     up = Array.from(document.querySelectorAll("img[src='/images/icons/social/veranda_quest_icon_2.png']"));
//     if (up.length == 2){
//       mytext = "FUMY";
//     }
...
//     up = Array.from(document.querySelectorAll("img[src='/images/icons/social/veranda_quest_icon_6.png']"));
//     if (up.length == 2){
//       mytext = "night";
//     }

//     up = Array.from(document.querySelectorAll("img[src='/images/icons/social/veranda_quest_icon_5.png']"));
//     if (up.length == 2){
//       mytext = "wind";
//     }
