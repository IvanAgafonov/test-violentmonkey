...
// @version      0.11
// @author       IvanAgafonov
// @match        https://monad-mainnet.talentum.id/
// @downloadURL  https://github.com/IvanAgafonov/test-violentmonkey/raw/main/talentum_gm.user.js
// @updateURL    https://github.com/IvanAgafonov/test-violentmonkey/raw/main/talentum_gm.user.js
...
async function autoBuy() {
  ...
  up = document.evaluate("//div[contains(normalize-space(), 'Streak Now!') and contains(@class, 'flex items-center streak-bg')]", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
  if (up){
    triggerEvents(up);
    await sleep(getRandomDelay(3000, 4000));
  }

  up = document.evaluate("//div[contains(normalize-space(), 'Streak Now!') and contains(@class, 'flex flex-row items-center')]", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue;
  if (up){
    triggerEvents(up);
    await sleep(getRandomDelay(3000, 4000));
  }
