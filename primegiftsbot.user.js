...
// @version      0.1
// @author       IvanAgafonov
// @match        https://bot.primegifts.org/*
// @downloadURL  https://github.com/IvanAgafonov/test-violentmonkey/raw/main/primegiftsbot.user.js
// @updateURL    https://github.com/IvanAgafonov/test-violentmonkey/raw/main/primegiftsbot.user.js
...
async function autoBuy() {
  ...
  var up = Array.from(document.querySelectorAll("button div")).filter(el => el.textContent == "Check" );
  if (up.length > 2){
    triggerEvents(up[2]);
...
function initializeScript() {
    ...
    setTimeout(autoBuy, getRandomDelay(13900, 13950));
}
